...
public class QueryProcConfigHandler
    extends ResourceConfigHandler {

    private static Logger logger = Logger.getLogger(QueryProcConfigHandler.class.getName());

    private static final String XPATH_STRING = "/service/queryprocessor";

    public QueryProcConfigHandler() throws XPathExpressionException, XPathFactoryConfigurationException {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Object[] tmpArray = cMan.getConfigurationElements(QueryProcessor.class);

            logger.info("Found query processor: " + tmpArray.length);
            for (Object obj : tmpArray) {
                QueryProcessor action = (QueryProcessor) obj;
